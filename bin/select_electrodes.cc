...
void write_vtk_points(string filename, sloc::Mesh &mesh, map_id_vector_t& nodemap)
{
    int i;
    int npts = 0;
...
{
    cerr << "Usage: " << pgm
         << " -m meshfile [-v vtkfile] -o outfile layer1/count1 layer2/count2 ..."
         << endl;
    exit(1);
}

void process_args(int argc, char *argv[], string& meshfile, string& vtkfile, string& outfile, map_layers_t& layers)
{
    char *pgm = argv[0];
...
int main(int argc, char *argv[])
{
    ...
    // process cli args
    string meshfile, vtkfile, outfile;
    map_layers_t layers;
    process_args(argc, argv, meshfile, vtkfile, outfile, layers);
