...
TinyVector<typename BinaryNumericTraits<T1,T2>::OpResult, N>
operator+(const TinyVector<T1,N>& v1, const TinyVector<T2,N>& v2)
{
...
template <typename T1, typename T2, int N>
TinyVector<typename BinaryNumericTraits<T1,T2>::OpResult, N>
operator*(const TinyVector<T1,N>& v1, const T2& x)
{
...
template <typename T, int N>
TinyVector<T,N>
operator*(const T& x, const TinyVector<T,N> v1)
{
    for (int i = 0; i < N; ++i)
        v1(i) = x * v1(i);
    return v1;
...
// x * v1 (disparate types)
template <typename T1, typename T2, int N>
TinyVector<typename BinaryNumericTraits<T1,T2>::OpResult, N>
operator*(const T2& x, const TinyVector<T1,N>& v1)
{
    return x * TinyVector<typename BinaryNumericTraits<T1,T2>::OpResult, N>(v1);
}
